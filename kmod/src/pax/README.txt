==============================================================================
           HOW TO BUILD AND LOAD THE PAX KERNEL DRIVER UNDER LINUX*
==============================================================================
...
to build and load the PAX kernel driver on the Linux* operating system.
...
must be present on the target system.
  ...
  Linux Distributions Based on Kernel 2.6
    ...
    * Red Hat Fedora* Core 5, 6, 7, 8, 9, 10, 11:
    ...
    * Novell SuSE Linux Professional 9.1, 9.2, 9.3:
      Novell OpenSuSE 10.0, 10.1:
    ...
    * Novell SuSE Linux Enterprise Server 10, 11:
      Novell OpenSuSE 10.2, 10.3, 11.0, 11.1, 11.2:
...
environment are installed, you can build and load the driver:
  ...
  cd /path/to/pax/sources/
  ./boot-script --install /path/to/pre-built-drivers
